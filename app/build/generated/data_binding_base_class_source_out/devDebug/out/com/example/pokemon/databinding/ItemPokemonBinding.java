...
public final class ItemPokemonBinding implements ViewBinding {
  ...
  private ItemPokemonBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView image,
  ...
  public static ItemPokemonBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPokemonBinding((ConstraintLayout) rootView, image, name);
    }
